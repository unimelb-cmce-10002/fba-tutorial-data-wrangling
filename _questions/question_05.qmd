...
The last code chunk prior to the in-class exercises will load the correct `firm_strategy` dataset. It's not visible in the html file, but should be in the .qmd file. Students who haven't prepared correctly (and tutors) can run this cell to proceed directly to the in-class exercises.
